...
Eu implementei várias funções para atender aos requisitos propostos e/ou testes unitários para garantir que as implementações das funções estão corretas.

---

# Instruções para rodar o meu projeto:

## Antes de começar a desenvolver:

1. Clone o repositório
  * `git clone git@github.com:flavioCoder1/JestTesting.git`.
...
### 2 - Implementei os casos de teste para a função `numbers`
...
### 4 - Implementei os casos de teste para a função `circle`
...
### 5 - Implementei a função `createStudent`
...
### 6 - Implementei os casos de teste para a função `productDetails`
...
### 7 - Implementei a função `objCalculator`
...
### 8 - Implementei a função `myCounter`
...
### 9 - Implementei os casos de teste e a função `createMenu`
